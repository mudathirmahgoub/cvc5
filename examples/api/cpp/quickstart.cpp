...
int main()
{
  ...
  double xDouble = xPair.first / (double)xPair.second;
  double yDouble = yPair.first / (double)yPair.second;
  double xMinusYDouble = xMinusYPair.first / (double)xMinusYPair.second;
