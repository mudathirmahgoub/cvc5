 ...
 */
EmptyBag::EmptyBag(const BagType& bagType) : d_type(new BagType(bagType)) {}

EmptyBag::EmptyBag(const EmptyBag& es) : d_type(new BagType(es.getType())) {}
...
const BagType& EmptyBag::getType() const { return *d_type; }
