...
class InferenceManager
{
 ...
 public:
  InferenceManager(TheoryBagsPrivate& p,
                   SolverState& s,
                   eq::EqualityEngine& e,
                   context::Context* c,
  ...
  /** Flush lemmas
   *
   * This sends lemmas on the output channel of the theory of bags.
   *
 ...
 private:
  ...
  Node d_true;
  Node d_false;
  /** the theory of bags which owns this */
  TheoryBagsPrivate& d_parent;
  /** Reference to the state object for the theory of bags */
  SolverState& d_state;
