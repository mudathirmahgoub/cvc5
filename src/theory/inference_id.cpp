...
const char* toString(InferenceId i)
{
  switch (i)
  {
    ...
    case InferenceId::NULLABLES_DISEQUAL: return "NULLABLES_DISEQUAL";
    case InferenceId::NULLABLES_LIFT_NULL: return "NULLABLES_LIFT_NULL";
    case InferenceId::NULLABLES_LIFT_SOME: return "NULLABLES_LIFT_SOME";
